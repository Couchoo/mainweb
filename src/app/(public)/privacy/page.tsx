        ...
        <div className="min-h-screen bg-brand-midnight text-brand-warmCream pt-32 pb-20">
            <div className="container max-w-4xl">
                ...
                <div className="prose prose-invert max-w-none space-y-6 text-brand-softLavender">
                    <p>Тази страница е в процес на подготовка. Поверителността и сигурността на вашите данни са наш основен приоритет.</p>
                    <p>За въпроси относно вашите данни, моля свържете се с нас на: <strong>info@bktfilters.com</strong></p>
                </div>
            </div>
        </div>
    );
